...
private:
	...
	float smoothedJoystickTurnInput = 0.0f;
	float lastJoystickTurnInput = 0.0f;
	float joystickTurnGraceTimer = 0.0f;
	bool rightJoystickCameraSuppressed = false;
	const float joystickTurnGraceTime = 0.08f;
	const float joystickTurnSmoothingSpeed = 18.0f;
...
public:
	...
	void SetRightJoystickCameraSuppressed(bool suppressed);
